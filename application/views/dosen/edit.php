...
<body>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?php echo form_open_multipart("C_dosen/update"); ?>
                <?php echo validation_errors(); ?>
                <div class="form-group row">
                    <label for="nip" class="col-sm-4 col-form-label">NIP</label>
                    <div class="col-sm-8">
                        <input type="hidden" name="id_old" value="<?php echo $record[0]->nip ?>">
                        <input type="text" name="nip" class="form-control" required="" id="nip" value="<?php echo $record[0]->nip; ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#kode_matkul').val('<?php echo $record[0]->kode_matkul ?>');
