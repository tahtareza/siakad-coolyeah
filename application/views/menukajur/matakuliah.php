...
$this->load->view('main12/navbarkajur');
?>
<div class="content-wrapper">
  <div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Data Matakuliah</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var tableajax = $('#mydata').DataTable({
            responsive: true,
            ajax: '<?php echo base_url("C_matakuliah/getAjax") ?>',
            columns: [
            { 
                data: null,
        ...
        $('#btn_lihat').on('click',function(){
            ...
            rownumber=0;
            tableajax.ajax.url("<?php echo base_url('C_matakuliah/getAjax/') ?>"+selected).load();
        });
