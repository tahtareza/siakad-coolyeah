...
<script type="text/javascript">
    $(document).ready(function(){  
        ...
        function tampil_data(){
            $.ajax({
                type  : 'ajax',
                url   : '<?php echo base_url("C_tahunajar/read") ?>',
                async : false,
                dataType : 'json',
        ...
        $('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_tahunajar/add')?>",
                dataType : "JSON",
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('C_tahunajar/where')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
        ...
        $('#btn_update').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_tahunajar/update')?>",
                dataType : "JSON",
                data : {kode:kode , nama:nama},
                success: function(data){
                    $('[name="kode_edit"]').val("");
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_tahunajar/delete')?>",
                dataType : "JSON",
                data : {kode: kode},
                success: function(data){
