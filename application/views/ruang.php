            ...
            <form class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="kuota_add" id="kuota1" class="form-control" type="number">
                        </div>
                    </div>
            ...
            <form class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Kuota</label>
                        <div class="col-xs-9">
                            <input name="kuota_edit" id="kuota2" class="form-control" type="number">
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function(){  
        ...
        $('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_ruang/add')?>",
                dataType : "JSON",
                data : {kode:kode , nama:nama, kuota:kuota, kode_jurusan:kode_jurusan},
                success: function(data){
                    $('[name="kode_add"]').val("");
                    $('[name="nama_add"]').val("");
                    $('[name="kuota_add"]').val("");
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('C_ruang/where')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
                    $.each(data,function(kode, nama, kuota, kode_jurusan){
                        $('#ModalUpdate').modal('show');
                        $('[name="kode_edit"]').val(data.kode);
                        $('[name="nama_edit"]').val(data.nama);
                        $('[name="kuota_edit"]').val(data.kuota);
        ...
        $('#btn_update').on('click',function(){
            var kode=$('#kode2').val();
            var nama=$('#nama2').val();
            var kuota=$('#kuota2').val();
            var kode_jurusan=$('#kode_jurusan2').val();
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_ruang/update')?>",
                dataType : "JSON",
                data : {kode:kode , nama:nama, kuota:kuota, kode_jurusan:kode_jurusan},
                success: function(data){
                    $('[name="kode_edit"]').val("");
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_ruang/delete')?>",
                dataType : "JSON",
                data : {kode: kode},
                success: function(data){
