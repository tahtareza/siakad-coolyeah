            ...
            <form class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="status_add" id="status1" class="form-control" type="number">
                        </div>
                    </div>
            ...
            <form class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >Status</label>
                        <div class="col-xs-9">
                            <!-- <input name="status_edit" id="status2" class="form-control" type="number"> -->
                            <select class="form-control" name="status_edit" id="status2">
                                <option>0</option>
                                <option>1</option>
                            </select>
                            <!-- <label class="switch">
                                <input type="checkbox" id="checkValue" name="mycheckbox">
...
<script type="text/javascript">
    $(document).ready(function(){  
        ...
        function tampil_data(){
            $.ajax({
                type  : 'ajax',
                url   : '<?php echo base_url("C_semester/read") ?>',
                async : false,
                dataType : 'json',
                success : function(data){
                    ...
                    for(i=0; i<data.length; i++){
                        ...
                        '<td>'+data[i].nama+'</td>'+
                        '<td>'+data[i].status+'</td>'+
                        // '<td>'+'<label class="switch"><input type="checkbox" id="checkValue" name="mycheckbox"><span class="slider round"></span></label>'+'</td>'+
        ...
        $('#btn_simpan').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_semester/add')?>",
                dataType : "JSON",
        ...
        $('#show_data').on('click','.item_edit',function(){
            ...
            $.ajax({
                type : "GET",
                url  : "<?php echo base_url('C_semester/where')?>",
                dataType : "JSON",
                data : {id:id},
                success: function(data){
                    $.each(data,function(kode, nama, status){
        ...
        $('#btn_update').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_semester/update')?>",
                dataType : "JSON",
                data : {kode:kode , nama:nama, status:status},
                success: function(data){
                    $('[name="kode_edit"]').val("");
        ...
        $('#btn_hapus').on('click',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('C_semester/delete')?>",
                dataType : "JSON",
                data : {kode: kode},
                success: function(data){
