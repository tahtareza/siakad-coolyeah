...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Detail KRS</h1>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a href="<?php echo base_url('C_menu/krs') ?>" class="btn btn-sm btn-info"><span class="fa fa-arrow-left"></span> Kembali</a>
                </div>
                <!-- /.panel-heading -->
